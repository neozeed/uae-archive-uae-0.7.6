...
{
    if     (matchstr(&line,"ON"))     currprefs.fake_joystick = 2;
    else if(matchstr(&line,"OFF"))    currprefs.fake_joystick = 0;
    else if(matchstr(&line,"TOGGLE")) currprefs.fake_joystick =
